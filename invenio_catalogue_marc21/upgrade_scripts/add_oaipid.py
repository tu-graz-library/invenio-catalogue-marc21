...
"""Add OAI PIDs to existing marc21 and marc21-catalogue records."""
...
def execute_upgrade():
    ...
    apis = {
        "records": {
            "base": Marc21Record,
            "catalogue": Marc21CatalogueRecord,
        },
        "drafts": {
            "base": Marc21Draft,
            "catalogue": Marc21CatalogueDraft,
        },
    }
    ...
    for api_type in apis.values():
        ...
        for record_metadata in base_cls.model_cls.query.all():
            try:
                ...
                api_cls = (
                    api_type["catalogue"] if is_catalogue_record(data) else base_cls
                )
